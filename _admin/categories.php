          ...
          <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="box-link"><a href="manage_category.php">Add </a></h4>
                </div>
                <div class="card-body--">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <?php 
                                  if($row['status'] == 1){
                                    echo "<span class='badge badge-complete'><a href='?type=status&operation=deative&id=".$row['id']."'>Active</a></span>&nbsp;";
                                  }else{
